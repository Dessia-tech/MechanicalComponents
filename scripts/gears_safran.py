...
GA2=gears.GearAssemblyOptimizer(gear_set=list_gear_set2,gear_speed=list_speed2,center_distance=list_cd2,rack_list=list_rack2,rack_choice=list_rack_choice2,helix_angle=list_helix_angle2,material=list_material2,torque=list_torque2,cycle=list_cycle2)
GA2.SearchCenterLine(nb_sol=1)
sol=GA2.solutions_search[-1]

sol.SVGExport('name.txt',{5:[0,0]})
