...
egs2=genmechanics.geometry.Direction2Euler(dgs1)
print(egs2)
bearing1=linkages.FrictionlessRevoluteLinkage(ground,shaft1,p1a,egs1,'bearing1a')
#bearing1=linkages.LinearAnnularLinkage(ground,shaft1,p1b,[0,0,0],Cr,'bearing1b')
bearing2=linkages.FrictionlessRevoluteLinkage(ground,shaft2,p2a,egs1,'bearing2a')
#bearing2b=linkages.LinearAnnularLinkage(ground,shaft2,p2b,[0,0,0],Cr,'bearing2b')

gearset12=linkages.FrictionlessGearSetLinkage(shaft1,shaft2,pgs1,egs2,alpha_gs1,beta_gs1,'Gear set 2')

load1=loads.KnownLoad(shaft1,[0,0,-L/4],egs1,[0,0,0],[C,0,0],'input torque')
load2=loads.SimpleUnknownLoad(shaft2,[0,e1,0],egs1,[],[0],'output torque')
