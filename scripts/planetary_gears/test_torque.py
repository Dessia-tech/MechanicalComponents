...
pgs7=npy.array([0,Z6*m2*0.5,0])

print(pgs6-pgs4)
dgs1=npy.cross(pgs3-p1a,pgs3-p1b)
egs1=genmechanics.geometry.Direction2Euler(pgs1,dir_axis)
...
pivot2=linkages.FrictionlessRevoluteLinkage(shaft3,shaft5,pgs4,[0,0,0],'pivot2')
print(egs1)
...
load1=loads.KnownLoad(shaft6,[-Lb/2,0,0],[0,0,0],[0,0,0],[C1,0,0],'input torque')
load4=loads.KnownLoad(shaft3,[Ld-Lb/2,0,0],[0,0,0],[0,0,0],[C2,0,0],'input torque2')
...
imposed_speeds=[(bearing1a,0,w),(bearing4a,0,200)]
...
print(len([bearing1a,bearing1b,bearing2a,bearing2b,bearing3a,bearing3b,bearing4a,bearing4b,gearset12,gearset23,gearset45,gearset46,pivot,pivot2]))
