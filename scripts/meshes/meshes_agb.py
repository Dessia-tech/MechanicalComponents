...
meshopti7 = meshes_opt.MeshOpti(rack=rack, torque_input= 0, speed_input=(455.8158304033849, 700.216642218943), gearing_interior='True')
...
center_distance6 = meshes_opt.CenterDistanceOpti((0.001237916425095688, 0.05),[meshopti6,meshopti7])
