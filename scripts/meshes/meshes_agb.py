...
meshopti2=meshes_opt.MeshOpti(rack=rack,torque_input= 0, speed_input=(449.8807309958231, 472.95153771355757))
meshopti3=meshes_opt.MeshOpti(rack=rack,torque_input= -410, speed_input=(1875.9428646237072, 1972.145062809538))
...
meshopti7=meshes_opt.MeshOpti(rack=rack,torque_input= 0, speed_input=(865.8158304033849, 910.216642218943))
...
center_distance6=meshes_opt.CenterDistanceOpti((0.10237916425095688, 0.11892529180666707),[meshopti6,meshopti7])
center_distances=[[center_distance1],[center_distance2],[center_distance3],
                  [center_distance4],[center_distance5],[center_distance6]]
