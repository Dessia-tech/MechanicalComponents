...
#3 gears meshes test
list_cd=[[0.09,0.1],[0.09,0.1],[0.09,0.1],[0.09,0.1]]
connections=[[(1,2)],[(3,4)],[(2,5),(4,6)],[(5,7),(6,8)]]
list_strong_link=[[2,4]]
list_speed={1:[1000*npy.pi/30,1050*npy.pi/30],2:[1000*npy.pi/30,1050*npy.pi/30],
            3:[1000*npy.pi/30,1050*npy.pi/30],4:[1000*npy.pi/30,1050*npy.pi/30],
            5:[1000*npy.pi/30,1050*npy.pi/30],6:[1000*npy.pi/30,1050*npy.pi/30],
            7:[1000*npy.pi/30,1050*npy.pi/30],8:[1000*npy.pi/30,1050*npy.pi/30]}
